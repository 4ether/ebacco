...
<body>
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="../tampilan_contact/contact.php">Contact</a></li>
                <li><a href="../Tampilan_Login/login.php">Login</a></li>
                <li><a href="../Tampilan_Login/login.php">Admin</a></li>
            </ul>
        </div>
    </section>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-details">
            ...
            <h2><?php echo str_replace(',', '.', number_format($item['harga'])) ?></h2>
            <hr>
            <h5 style="color: red;">Harap login terlebih dahulu untuk membeli produk</h5>
            <hr>
            <h4>Detail Produk</h4>
